...
for subDir, dirs, files in os.walk(sourceDir):
    if skipFirst == 1:
        ...
        for file in files:
            ...
            #If a variable didn't have anything assigned to it, add it to the dictionary 
            #that way at the end of the file reading we can look at all the files that have errors
            if location == "":
                locationDict[file] = ""
            if materialDated == "":
...
#be sure to update this whenever you add new stuff
