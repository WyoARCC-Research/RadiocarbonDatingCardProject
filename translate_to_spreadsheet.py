#This script takes a a directory containing "organized outputs" anc converts them to an excel spreadsheet by filling
...
#this way so we can iterate over fields, the letters are their corresponding columns in the spreadsheet
...
input = 'D:\\ARCC\\ARCCradiocarbon_project\\excelreferences\\organized'
output = 'D:\\ARCC\\ARCCradiocarbon_project\\excelreferences'

#the main function to use
def translate_to_spreadsheet(dirinput):

    wb = load_workbook('CARD Upload Template.xlsx')
    ws =wb['Data Fields'] # make sure we are on the right page of the spreadhseet
    ...
    wb.save('D:\\ARCC\\ARCCradiocarbon_project\\excelreferences\\Card_Upload_Template_Output.xlsx')
